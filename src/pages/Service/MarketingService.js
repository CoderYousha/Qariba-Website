...
const service = {
    title: "خدمات تسويق إلكتروني احترافية تحقق نموا حقيقيا لعلامتك",
    description:
        "تقدّم قريبة حلول تسويق إلكتروني متكاملة تعتمد على استراتيجيات مدروسة تجمع بين الإبداع والتحليل بهدف تعزيز حضورك الرقمي وزيادة التفاعل وتحقيق نتائج ملموسة نحن لا نركز على الانتشار فقط بل على بناء تأثير حقيقي يدعم نمو أعمالك",
    features: [
        {
            id: 1,
            name: "خطط تسويقية فعالة",
            icon: "📋",
            detail: {
                title: "خطط تسويقية فعالة",
                description:
                    "نضع استراتيجيات تسويقية مدروسة تعتمد على تحليل السوق وسلوك الجمهور بهدف تعزيز حضورك الرقمي وزيادة المبيعات نصمم خططا مخصصة تساعدك على تحقيق نتائج قابلة للقياس وأفضل عائد على الاستثمار",
                points: [
        ...
        },
        {
            ...
            icon: "🎨",
            detail: {
                title: "إعلانات السوشال ميديا",
                description:
                    "نصمم وندير حملات إعلانية مدفوعة تستهدف جمهورك بدقة، لزيادة التفاعل وتحويله إلى نتائج ومبيعات حقيقية نعتمد على البيانات والتحليل المستمر لتحقيق أفضل عائد على استثمارك الإعلاني",
                points: [
        ...
        {
            id: 3,
            name: "إدارة صفحات السوشال ميديا",
            icon: "🌐",
            detail: {
                title: "إدارة صفحات السوشال ميديا",
                description:
                    "ندير حسابات التواصل الاجتماعي باحترافية لبناء حضور رقمي قوي، وتعزيز التفاعل مع جمهورك وتحقيق نمو مستدام لعلامتك التجارية من خلال محتوى واستراتيجيات مدروسة",
                points: [
        ...
        {
            id: 4,
            name: "كتابة محتوى تفاعلي جذاب",
            icon: "🔵",
            detail: {
                title: "كتابة محتوى تفاعلي جذاب",
                description:
        ...
        {
            id: 6,
            name: "تزويد متابعين حقيقيين",
            icon: "🛍️",
            detail: {
                title: "تزويد متابعين حقيقيين",
                description:
        ...
        },
        {
            ...
            icon: "💻",
            detail: {
                title: "التسويق عبر الرسائل النصية",
                description:
